...
public class sketch_aug14b extends PApplet {
...
float moonY = map(mouseY,0,height,168,188);
  ...
  //get bigger circle
    ...
    fill(0,150);
    ellipse(moonX,moonY,ss*.7f,ss*.7f);
    ellipse(moonX,moonY,ss*.5f,ss*.5f);
    ellipse(moonX,moonY,ss*.25f,ss*.25f);
  }
  if (second()%10==8){
    ss=1;
  }
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "sketch_aug14b" });
  }
}
