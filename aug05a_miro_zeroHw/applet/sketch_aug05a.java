...
public class sketch_aug05a extends PApplet {
  public void setup() {
  ...
  Font1 = loadFont("AleOrnamentsSpiratoLL-48.vlw");
  Font2 = loadFont("AleOrnamentsRotatoLL-48.vlw");
  Font3 = loadFont("AquinasPlain-48.vlw");
  Font4 = loadFont("AstrotypePLTStd-Regular-48.vlw");
  ...
  textFont(Font2,55);
  text("0", 0, 633);
  // seems like the text won't go off screen
  textSize(100);
  text("0", 105, 460);
  ...
  textSize(100);
  text("0", 460, 390);
  //so it does go off the right side
