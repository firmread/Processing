...
/**
Demonstation of the PathTube class

Keys 0-9 control the speed
Space bar toggles tube style
Keys <> and left/right arrow change the tube shape
Click and drag mouse to change 3D view point

Also requires PeasyCam library
http://www.processing.org/reference/libraries/#3d

@author Peter Lager 2010
*/
