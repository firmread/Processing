 ...
 * a 3D shape by rotating it about the Y axis [0,1,0].
 *
 * Degree	Shape					<br>
 *   2		straight line			<br>
...
public class Bezier2D {
	 ...
	 */
	public Bezier2D(float[][] points, int nbrPoints){
		degree = nbrPoints;
		makeArrays();
	 ...
	 */
	public Bezier2D(PVector[] points, int nbrPoints){
