/**
  *  This sketch demonstrates how to use a SquareWave with an AudioOutput.<br />
  *  Move the mouse up and down to change the frequency, left and right to change the panning.<br />
  *  <br />
  *  SquareWave is a subclass of Oscillator, which is an abstract class that implements the interface AudioSignal.<br />
