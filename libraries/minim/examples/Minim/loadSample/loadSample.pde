/**
  * This sketch demonstrates how to use the <code>loadSample</code> method of <code>Minim</code>. The <code>loadSample</code> 
  * method allows you to specify the sample you want to load with a <code>String</code> and optionally specify what you 
  * want the buffer size of the returned <code>AudioSample</code> to be. If you don't specify a buffer size, the returned 
  * sample will have a buffer size of 1024. Minim is able to load wav files, au files, aif files, snd files, and mp3 
  * files. When you call <code>loadSample</code>, if you just specify the filename it will try to load the sample from 
  ...
  * method of any <code>AudioSamples</code>'s you have received from <code>loadSample</code>.
  * <p>
