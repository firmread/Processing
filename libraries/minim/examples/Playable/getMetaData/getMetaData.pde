/**
  * This sketch demonstrates how to use the <code>getMetaData</code> method of <code>AudioPlayer</code>. This method is also 
  * available for <code>AudioSnippet</code> and <code>AudioSample</code>. You should use this method when you want to retrieve 
  * metadata about a file that you have loaded, like ID3 tags from an mp3 file. If you load WAV file or other non-tagged file,
  * most of the metadata will be empty, but you will still have information like the filename and the length.
  *
  */
