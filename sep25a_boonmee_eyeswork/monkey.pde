class Monkey{
  ...
  e1 = new Eye( 231,  213, 20);
  e2 = new Eye( 258,  216, 20);
  e3 = new Eye( 120,  263, 20);
  e4 = new Eye( 148,  266, 20);
  e5 = new Eye( 330,  252, 20);
  e6 = new Eye( 357,  257, 20);
  }
  
  void drawMonkey(){
    pushMatrix();
    translate (this.mkx,this.mky);
    scale(this.mksc);
    ...
    e1.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e1.display();    
    e2.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e2.display(); 
    e3.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e3.display();
    e4.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e4.display();    
    e5.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e5.display(); 
    e6.update(mouseX, mouseY,this.mkx,this.mky,this.mksc);
    e6.display();    
    //EYES
    //setup eye fill
